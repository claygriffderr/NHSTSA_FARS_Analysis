class mappingPipeline:
    ...
    def assign_mappings(self,df):
        ...
        for pair in unknown_conversions:
            ...
            df[col_name] = df[col_name].replace(unknown_vals, 0)

        #for a few columns 0 is already assigned so it has to be changed first
        df['HOUR'] = df["HOUR"].replace([99, 0], [0, 24])
        df['MAN_COLL'] = df['MAN_COLL'].replace([0,9],[9,0])
    ...
    def RUR_URB_init(self):
        ...
        self.RUR_URBmap.update({val: 0 for val in list_0})
    ...
    def HARM_EV_init(self):
        ...
        self.HARM_EVmap.update({val: 0 for val in list_0})
    ...
    def LGT_COND_init(self):
        ...
        self.LGT_CONDmap.update({val: 0 for val in list_0})
    ...
    def WEATHER_init(self):
        ...
        self.WEATHERmap.update({val: 0 for val in list_0})
    ...
    def OWNER_init(self):
        ...
        self.OWNERmap.update({val: 0 for val in list_0})
    ...
    def J_KNIFE_init(self):
        ...
        self.J_KNIFEmap.update({val: 0 for val in list_0})
    ...
    def L_STATUS_init(self):
        ...
        self.L_STATUSmap.update({val: 0 for val in list_0})
    ...
    def SPEEDREL_init(self):
        ...
        self.SPEEDRELmap.update({val: 0 for val in list_0})
